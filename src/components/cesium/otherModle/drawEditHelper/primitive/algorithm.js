...
xp.algorithm.doubleArrow = function (inputPoint) {
    ...
    if (!(t < 2)) {
        ...
        //  下面的是移动点位后的坐标
        t === 3 ? this.tempPoint4 = xp.algorithm.getTempPoint4(o, e, r) : this.tempPoint4 = this.points[3];
        t === 3 || t === 4 ? this.connPoint = P.PlotUtils.mid(o, e) : this.connPoint = this.points[4];
        var n, g;
...
xp.algorithm.getArrowBodyPoints = function (t, o, e, r) {
    ...
    for (let n = P.PlotUtils.wholeDistance(t), g = P.PlotUtils.getBaseLength(t), i = g * r, s = P.PlotUtils.distance(o, e), a = (i - s) / 2, l = 0, p = 1; p < t.length - 1; p++) {
        let h = P.PlotUtils.getAngleOfThreePoints(t[p - 1], t[p], t[p + 1]) / 2;
...
xp.algorithm.getTempPoint4 = function (t, o, e) {
    let r, n, g, i, s = P.PlotUtils.mid(t, o),
...
xp.algorithm.getAttackArrowHeadPoints = function (t, o, e, defaultParam) {
    ...
    let i = P.PlotUtils.distance(o, e);
    n > i * this.headTailFactor && (n = i * this.headTailFactor);
    let s = n * this.headWidthFactor,
        a = n * this.neckWidthFactor;
    n = n > r ? r : n;
    let l = n * this.neckHeightFactor,
...
xp.algorithm.getAttackArrowBodyPoints = function (t, o, e, r) {
    let n = P.PlotUtils.wholeDistance(t), g = P.PlotUtils.getBaseLength(t), i = g * r, s = P.PlotUtils.distance(o, e), a = (i - s) / 2, l = 0, u = [], c = [];
