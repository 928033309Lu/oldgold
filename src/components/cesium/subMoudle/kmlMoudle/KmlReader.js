define([
    ...
    'cesium/Core/Event',
    'cesium/Core/getExtensionFromUri',
    ...
    'cesium/ThirdParty/Autolinker',
    'cesium/ThirdParty/Uri',
    'cesium/ThirdParty/when',
    'cesium/ThirdParty/zip',
    'cesium/DataSources/BillboardGraphics',
    'cesium/DataSources/CompositePositionProperty',
    'cesium/DataSources/DataSource',
    'cesium/DataSources/DataSourceClock',
    'cesium/DataSources/Entity',
    'cesium/DataSources/EntityCluster',
    'cesium/DataSources/EntityCollection',
    'cesium/DataSources/KmlCamera',
    'cesium/DataSources/KmlLookAt',
    'cesium/DataSources/KmlTour',
    'cesium/DataSources/KmlTourFlyTo',
    'cesium/DataSources/KmlTourWait',
    'cesium/DataSources/LabelGraphics',
    'cesium/DataSources/PathGraphics',
    'cesium/DataSources/PolygonGraphics',
    'cesium/DataSources/PolylineGraphics',
    'cesium/DataSources/PositionPropertyArray',
    'cesium/DataSources/RectangleGraphics',
    'cesium/DataSources/ReferenceProperty',
    'cesium/DataSources/SampledPositionProperty',
    'cesium/DataSources/ScaledPositionProperty',
    'cesium/DataSources/TimeIntervalCollectionProperty',
    'cesium/DataSources/WallGraphics'
], function(
    AssociativeArray,
    BoundingRectangle,
    Cartesian2,
    ...
    function processDescription(node, entity, styleEntity, uriResolver, sourceResource) {
        ...
        entity.des = scratchDiv.innerHTML;
     ...
     * @param {Ellipsoid} [options.ellipsoid=Ellipsoid.WGS84] The global ellipsoid used for geographical calculations.
     *
     * @returns {Promise.<KmlReader>} A promise that will resolve to a new KmlReader instance once the KML is loaded.
     */
    KmlReader.load = function(data, options) {
        options = defaultValue(options, defaultValue.EMPTY_OBJECT);
        var dataSource = new KmlReader(options);
        return dataSource.load(data, options);
    };

    defineProperties(KmlReader.prototype, {
        /**
         * Gets or sets a human-readable name for this instance.
         * This will be automatically be set to the KML document name on load.
         * @memberof KmlReader.prototype
         * @type {String}
         */
        name : {
            get : function() {
     ...
     * @param {Ellipsoid} [options.ellipsoid=Ellipsoid.WGS84] The global ellipsoid used for geographical calculations.
     *
     * @returns {Promise.<KmlReader>} A promise that will resolve to this instances once the KML is loaded.
     */
    KmlReader.prototype.load = function(data, options) {
        //>>includeStart('debug', pragmas.debug);
        if (!defined(data)) {
     ...
     */
    KmlReader.prototype.update = function(time) {
    ...
    /**
     * Contains KML Feature data loaded into the <code>Entity.kml</code> property by {@link KmlReader}.
