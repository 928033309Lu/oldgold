...
<template>
    <div class="detail2" v-bind:style="{height:detailOneHeight+'px'}">
        <el-row>
            <el-col :span="8">
                <div class="box marL60 marR10">
                    <div class="box-header">项目参数</div>
                    <el-form label-position="left"
                             label-width="140px"
                             :model="project_params"
                             :rules="myrules"
                             ref="paramForm"
                             class="title-name-self"
                    >
                        <el-form-item label="区域/省/自治区：">
                            <div class="input-custom">{{project_params.province}}</div>
                        </el-form-item>
                        <el-form-item label="项目类型：">
                            <div class="input-custom" style="color:white !important;">{{project_params.project_type}}</div>
                        </el-form-item>
                        <el-form-item label="总容量：">
                            <div class="input-custom">{{project_params.project_capacity}}</div>
                            <div class="unit">MW</div>
                        </el-form-item>
                        <el-form-item label="参数规则：">
                            <el-select v-model="project_params.company"
                                       placeholder="请选择"
                                       popper-class="step3-popper details-popper" min-width="120px" style="width:130px;">
                                <el-option
                        ...
                        <el-form-item label="外送线路长度：" prop="out_line_len">
                                ...
                                :visible-arrow="false"
                                placement="top">
                            <el-input v-model="project_params.out_line_len" @blur="offBlur"></el-input>
                                </el-tooltip>
                            <!--<div class="input-custom">{{project_params.out_line_len}}</div>-->
                            <div class="unit">千米</div>
                        </el-form-item>
                        <el-form-item label="风机保质期：">
                            <div class="input-custom">{{project_params.fan_warranty_period}}</div>
                            <div class="unit">年</div>
                        </el-form-item>
                        <el-form-item label="场内道路：">
                            <div class="input-custom">{{project_params.pit_road}}</div>
                            <div class="unit">千米</div>
                        </el-form-item>
                        <el-form-item label="集电线路长度：">
                            <div class="input-custom">{{project_params.setline_len}}</div>
                            <div class="unit">千米</div>
                        </el-form-item>
                        <el-form-item label="集电线路架设方式：">
                            <div class="input-custom">{{project_params.setline_method}}</div>
                        </el-form-item>
                        <el-form-item label="核准日期：">
                            <el-input v-model="project_params.date_approval" @input="validateDateApproval"/>
                            <err-tip ref="dateApprovalErrTip" err-msg="请输入正确的日期格式：YYYY-MM-DD" style="margin-top:-25px"/>
                        </el-form-item>
                        <el-form-item label="开工日期：">
                            <el-input v-model="project_params.date_commencement" @input="validateDateCommencement"/>
                            <err-tip ref="dateCommencementErrTip" err-msg="请输入正确的日期格式：YYYY-MM-DD"
                                     style="margin-top:-25px"/>
                        </el-form-item>
                        <el-form-item label="市场交易电量比例：">
                            <div class="input-custom">{{project_params.market_power_ratio}}</div>
                            <div class="unit">%</div>
                        </el-form-item>
                        <el-form-item label="市场交易损失电价：">
                            <div class="input-custom">{{project_params.market_power_loss}}</div>
                            <div class="unit">元/kWh</div>
                        </el-form-item>
                        <el-form-item label="市场交易年数：">
                            <div class="input-custom">{{project_params.market_year}}</div>
                            <div class="unit">年</div>
                        </el-form-item>
                        <el-form-item label="集电线路电压等级：">
                            <div class="input-custom">{{project_params.voltage_level}}</div>
                            <div class="unit">kV</div>
                        </el-form-item>
                        <el-form-item label="限电率：">
                            <div class="input-custom">{{project_params.power_limiting_rate}}</div>
                            <div class="unit">%</div>
                        </el-form-item>
                        <el-form-item label="限电年数：">
                            <div class="input-custom">{{project_params.power_limiting_year}}</div>
                            <div class="unit">年</div>
                        </el-form-item>
                        <el-form-item label="资金成本：" prop="capital">
                                ...
                                :visible-arrow="false"
                                placement="top">
                            <el-input v-model="project_params.capital" @input="validateCapital" @blur="offBlur"/>
                                </el-tooltip>
                            <div class="unit">%
                        ...
                        <el-form-item label="资本金比例：" prop="capital_ratio">
                                ...
                                :visible-arrow="false"
                                placement="top">
                            <el-input v-model="project_params.capital_ratio" @input="validateCapitalRatio" @blur="offBlur"/>
                                </el-tooltip>
                            <div class="unit">%
                        ...
                        <el-form-item label="长期融资利率：" prop="long_term_financingrate">
                            ...
                            <el-input v-model="project_params.long_term_financingrate"
                                      @input="validateLongTermFinancingrate" @blur="offBlur"/>
                                      </el-tooltip>
                            <div class="unit">%
                        ...
                        <el-form-item label="融资期限：" prop="deadline">
                                ...
                                :visible-arrow="false"
                                placement="top">
                            <el-input v-model="project_params.deadline" @input="validateDeadline" @blur="offBlur"/>
                                </el-tooltip>
                            <div class="unit">年
            ...
            <el-col :span="8">
                <div class="box marR10 marL10">
                    <div class="box-header">风资源参数</div>
                    <el-form label-position="left" label-width="140px" :model="wind_params" ref="windParams" :rules="myrules2" class="title-name-self">
                        <el-form-item label="等效小时数：">
                            <div class="input-custom">{{wind_params.generating_hours}}</div>
                        ...
                        <el-form-item label="折减后等效小时数：">
                            <div class="input-custom">{{wind_params.cut_hour}}</div>
                        ...
                        <el-form-item label="海拔高差：">
                            <div class="input-custom">{{wind_params.altitude}}</div>
                            <div class="unit">米</div>
                        </el-form-item>
                        <el-form-item label="水平距离差：">
                            <div class="input-custom">{{wind_params.horizontal_distance}}</div>
                            <div class="unit">千米</div>
                        </el-form-item>
                ...
                <div class="box marR10 marL10 marT20">
                    <div class="box-header">机组参数</div>
                    <el-table
                            :data="turbine_params"
                            style="width: 100%"
                    ...
                    >
                        ...
                        >
                            <template slot-scope="scope">
                                ...
                                <div class="unit" style="margin-left: -30px;display: inline-block;">元/kW
            ...
            <el-col :span="8">
                <div class=" left-relative">
                    <div class="box marR60 marL10" v-bind:class="{overFlow: overFlow}">
                        <div class="box-header">工程量概算参数</div>
                        <el-form label-position="left" label-width="170px" :model="engineering_params" :rules="myrules3" class="title-name-self">
                            <el-form-item label="地形：">
                                <el-select v-model="engineering_params.terrain"
                                           placeholder="请选择"
                                           popper-class="step3-popper details-popper">
                                    <el-option
                            ...
                            <el-form-item label="建设工期：" prop="construction_time">
                                ...
                                <el-input v-model="engineering_params.construction_time"
                                          @input="validateConstructionTime"  @blur="offBlur"></el-input>
                                    </el-tooltip>
                                <div class="unit">月
                            ...
                            <el-form-item label="钢塔单价：" prop="tower_price">
                                    ...
                                    :visible-arrow="false"
                                    placement="top">
                                <el-input v-model="engineering_params.tower_price" @input="validateTowerPrice" @blur="offBlur"></el-input>
                                    </el-tooltip>
                                <div class="unit">元/吨
                            ...
                            <el-form-item label="锚栓单价（仅瞄栓）：" prop="anchor_price">
                                    ...
                                    :visible-arrow="false"
                                    placement="top">
                                <el-input v-model="engineering_params.anchor_price" @input="validateAnchorPrice" @blur="offBlur"></el-input>
                                    </el-tooltip>
                                <div class="unit">元/吨
                            ...
                            <el-form-item label="混凝土段总价：" prop="total_concreteprice">
                                ...
                                <el-input v-model="engineering_params.total_concreteprice"
                                          @input="validateTotalConcreteprice"  @blur="offBlur"></el-input>
                                          </el-tooltip>
                                <div class="unit">万元
                            ...
                            <el-form-item label="送出工程：" prop="send_project">
                                    ...
                                    :visible-arrow="false"
                                    placement="top">
                                <el-input v-model="engineering_params.send_project" @input="validateSendProject" @blur="offBlur"></el-input>
                                    </el-tooltip>
                                <div class="unit">万元
                            ...
                            <el-form-item label="10KV开关站：" prop="ten_switching">
                                ...
                                <el-input v-model="engineering_params.ten_switching"
                                          @input="validateTenSwitching" @blur="offBlur"></el-input>
                                          </el-tooltip>
                                <div class="unit">座
                            ...
                            <el-form-item label="35KV开关站：" prop="thirtyfive_switching">
                                ...
                                <el-input v-model="engineering_params.thirtyfive_switching"
                                          @input="validateThirtyfiveSwitching" @blur="offBlur"></el-input>
                                          </el-tooltip>
                                <div class="unit">座
                            ...
                            <el-form-item label="钢塔重量（选填）：" prop="tower_weight">
                                    ...
                                    :visible-arrow="false"
                                    placement="top">
                                <el-input v-model="engineering_params.tower_weight" @input="validateTowerWeight" @blur="offBlur"></el-input>
                                </el-tooltip>
                                <div class="unit">t
                            ...
                            <el-form-item label="锚栓重量（选填）：" prop="anchor_weight">
                                ...
                                <el-input v-model="engineering_params.anchor_weight"
                                          @input="validateAnchorWeight" @blur="offBlur"></el-input>
                                        </el-tooltip>
                                <div class="unit">t
                            ...
                            <el-form-item label="基础混凝土（选填）：" prop="base_reinforcement">
                                ...
                                <el-input v-model="engineering_params.base_reinforcement"
                                          @input="validateBaseReinforcement" @blur="offBlur"></el-input>
                                          </el-tooltip>
                                <div class="unit">m^3
                            ...
                            <el-form-item label="基础钢筋（选填）：" prop="foundation_concrete1">
                                ...
                                <el-input v-model="engineering_params.foundation_concrete1"
                                          @input="validateFoundationConcrete1" @blur="offBlur"></el-input>
                                          </el-tooltip>
                                <div class="unit">t
                            ...
                            <el-form-item label="单台吊装费用（选填）：" prop="single_hoistingcost">
                                ...
                                <el-input v-model="engineering_params.single_hoistingcost"
                                          @input="validateSingleHoistingcost" @blur="offBlur"></el-input>
                                          </el-tooltip>
                                <div class="unit">万元
                            ...
                            <el-form-item label="线路导线截面：" prop="conductor_cross">
                                    ...
                                    :visible-arrow="false"
                                    placement="top">
                                <el-input v-model="engineering_params.conductor_cross" class="conductorCross"
                                          @input="validateConductorCross"  @blur="offBlur"></el-input>
                                          </el-tooltip>
                                <div class="unit">平方毫米
                            ...
                            <div class="custom-table-header">
                                <div></div>
                                <div class="minbox">土方开挖<span>m<sup>3</sup></span></div>
                                <div class="minbox minbox1">石方开挖<span>m<sup>3</sup></span></div>
                                <div class="minbox2">回填<span>m<sup>3</sup></span></div>
                                <div class="minbox">外运距离<span>km</span></div>
                            </div>
                            <div class="custom-table-row">
                                <div style="width:60px;margin-left:5px;">风机基础</div>
                                <div v-for="(item, index) in engineering_params.fanbase" :key="510+index" class="input-con">
                                        ...
                                        :visible-arrow="false"
                                        placement="top">
                                    <el-input type="number" style="text-align: center;" v-model="engineering_params.fanbase[index]" 
                                   :style="!/^\d+(\.\d{1,4})?$/.test(engineering_params.fanbase[index])? redBorder:''"
                                        v-bind:class="{exWidth: index === 0 || index === 2,minWidth: index !== 0 && index !== 2}"></el-input>
                                        </el-tooltip>
                                </div>
                            </div>
                            <div class="custom-table-row">
                                <div style="width:60px;margin-left:5px;">风机平台</div>
                                <div v-for="(item, index) in engineering_params.fanplatform" :key="520+index">
                                        ...
                                        :visible-arrow="false"
                                        placement="top">
                                    <el-input type="number" style="text-align: center;" v-model="engineering_params.fanplatform[index]"
                            ...
                            <div class="custom-table-row">
                                <div style="width:60px;margin-left:5px;">升压站</div>
                                <div v-for="(item, index) in engineering_params.boosterstation" :key="530+index">
                                        ...
                                        :visible-arrow="false"
                                        placement="top">
                                    <el-input type="number" style="text-align: center;" v-model="engineering_params.boosterstation[index]"
                            ...
                            <div class="custom-table-row">
                                <div style="width:60px;margin-left:5px;">进场道路</div>
                                <div v-for="(item, index) in engineering_params.stationroad" :key="540+index">
                                        ...
                                        :visible-arrow="false"
                                        placement="top">
                                    <el-input type="number" style="text-align: center;" v-model="engineering_params.stationroad[index]"
                            ...
                            <div class="custom-table-row">
                                <div style="width:60px;margin-left:5px;">场内道路</div>
                                <div v-for="(item, index) in engineering_params.baseroad" :key="550+index">
                                        ...
                                        :visible-arrow="false"
                                        placement="top">
                                    <el-input type="number" style="text-align: center;" v-model="engineering_params.baseroad[index]"
                            ...
                            <div class="custom-table-row">
                                <div style="width:60px;margin-left:5px;">改建道路</div>
                                <div v-for="(item, index) in engineering_params.redevelopmentroad" :key="560+index">
                                        ...
                                        :visible-arrow="false"
                                        placement="top">
                                    <el-input type="number" style="text-align: center;"
                            ...
                            <div class="custom-table-row">
                                <div style="width:60px;margin-left:5px;">集电线路</div>
                                <div v-for="(item, index) in engineering_params.fanbase" :key="570+index">
                                        <el-tooltip class="item" 
                                        effect="light" 
                                        popper-class="offmytooltip"
                                        content="正数，可保留四位小数"
                    ...
                    <div class="details-more" @click="loadMore" v-if="overFlow" v-bind:style="{width:loadMoreWidth}">
                        更多...
                    </div>
                    <div class="details-more" @click="hiddenMore" v-else v-bind:style="{width:loadMoreWidth}">
                        收起
                    </div>
                </div>
            </el-col>
            <el-col :span="24">
                <div class="saveButton" @click="post">
                    保存并刷新经评结果
                </div>
            </el-col>
        </el-row>
        ...
        methods: {
            ...
            post() {
                ...
                if (!this.validateConstructionTime() || !this.validateTowerPrice() || !this.validateAnchorPrice() ||
                    ...
                    !this.validateConductorCross() || !this.vUnitPriceAll()) {
                    this.$message.error('请确认您的数据格式!');
                    return;
                }
