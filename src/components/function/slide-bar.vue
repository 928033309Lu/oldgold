...
<script>
    export default {
        ...
        watch: {
            ...
            // }
            selectedData () {
                this.$emit('changeFanRotaAngle', this.selectedData);
            }
        },
        methods: {
            show (visible, left, dataList, selectedData) {
                ...
                this.leftPosition = (65 - barWidth) / 2;
            ...
            onClick (data) {
                ...
                this.$parent && this.$parent.$parent && this.$parent.$parent.$emit('dataChange', this.functionId, this.selectedData, this.projectId);
            },
